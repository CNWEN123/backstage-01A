      ...
      list: [
        {
          ...
          target_type: 'agent',
          valid_bet: 520000,
          profit: 85000, // 输赢金额（平台赢85000）
          wash_code_rate: 2.0, // 洗码率 2%
          wash_code_fee: 10400, // 洗码费 = 520000 * 2% = 10400
          share_ratio: 30, // 占成比例 30%
          commission_amount: 22380, // 佣金 = (85000 - 10400) * 30% = 22380
          status: 'settled'
        },
        {
          id: 2,
          ...
          target_type: 'player',
          valid_bet: 110000,
          profit: -15000, // 输赢金额（平台输15000，玩家赢）
          wash_code_rate: 2.5, // 洗码率 2.5%
          wash_code_fee: 2750, // 洗码费 = 110000 * 2.5% = 2750
          share_ratio: 50, // 占成比例 50%
          commission_amount: -8875, // 佣金 = (-15000 - 2750) * 50% = -8875（玩家赢了，代理亏损）
          status: 'pending'
        },
        {
          id: 3,
